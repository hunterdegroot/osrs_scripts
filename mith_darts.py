...
for i in range(217):
    rebank()
    pyautogui.moveTo(679, 452)
    time.sleep(.4)
    click_random_position(679, 452, 2, 2)
    time.sleep(5)
    pyautogui.moveTo(379, 339)
    time.sleep(.4)
    click_random_position(379, 339, 2, 2)
    time.sleep(83)
    click_random_position(594, 99, 2, 1)
    pyautogui.moveTo(73, 546)
    time.sleep(.4)
    click_random_position(73, 546, 2, 2)
    time.sleep(5)
